...
test('Should be able to convert a number to ComplexNumber', () => {
    expect(ComplexNumber.convertToComplexNumber(3)).toStrictEqual(new ComplexNumber({ real: 3, imaginary: 0 }));
});

test('Should be able to convert a negative number to ComplexNumber', () => {
    expect(ComplexNumber.convertToComplexNumber(-1)).toStrictEqual(new ComplexNumber({ real: -1, imaginary: 0 }));
});
...
test('Should be able to add two ComplexNumbers', () => {
    ...
    expect(complexNumber1.add(complexNumber2)).toStrictEqual(new ComplexNumber({ real: 5, imaginary: 3}));
});
...
test('Should be able to subtract two ComplexNumbers', () => {
    ...
    expect(complexNumber1.subtract(complexNumber2)).toStrictEqual(new ComplexNumber({ real: 5, imaginary: -2}));
});
...
test('Should be able to multiply two ComplexNumbers', () => {
    ...
    expect(complexNumber1.multiply(complexNumber2)).toStrictEqual(new ComplexNumber({ real: 3, imaginary: 28}));
});